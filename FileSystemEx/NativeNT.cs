...
namespace netCommander.FileSystemEx
{
    ...
    public struct REPARSE_DATA_BUFFER_SYMLINK
    {
        ...
        */
        ...
        {
            REPARSE_DATA_BUFFER_SYMLINK ret = new REPARSE_DATA_BUFFER_SYMLINK();
        ...
        {
            int subst_len = Encoding.Unicode.GetBytes(SubstituteName, 0, SubstituteName.Length, PathBuffer, 0);
            //add space for null symbol
            int prn_len = Encoding.Unicode.GetBytes(PrintName, 0, PrintName.Length, PathBuffer, subst_len + sizeof(char));
    ...
    public struct REPARSE_DATA_BUFFER_MOUNTPOINT
    {
        ...
        */
        ...
        {
            REPARSE_DATA_BUFFER_MOUNTPOINT ret = new REPARSE_DATA_BUFFER_MOUNTPOINT();
            ret.PathBuffer = new byte[(WinApiFS.MAX_PATH * 2 + 2) * sizeof(char)];
